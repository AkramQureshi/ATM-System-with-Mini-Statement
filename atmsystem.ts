/*
    ...
    let balance = amount - amountWithdraw

    

    console.log("----------------------------------")
    console.log("You Widthdrawn Amount =", amountWithdraw)
    console.log("----------------------------------")
    ...
    let amountWithdraw2= 5000
    let balance2 = balance - amountWithdraw2

    console.log("------------------------------------------------------")
    console.log("You Widthdrawn Amount in 2nd Transaction =", amountWithdraw2)
    console.log("------------------------------------------------------")
    ...
    console.log("************************* ")
    console.log(" ")
    console.log("You withdrawn : ", amountWithdraw)
    console.log(" ")
    console.log("You withdrawn : ", amountWithdraw2)
    console.log(" ")
...
let customerName = "Akram Qureshi";
let amount = 10000;
let pin = 1234;
